...
import ScrollParallax from "./design/Scroll_Parallax";
import Generating from "./Generating";
import CompanyLogos from "./CompanyLogos";
// import MouseParallax from "./design/Mouse_Parallax";
		...
		>
			<div className="container relative">
				<div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
					...
					<Button href="/pricing" className="inline-flex" white>
						Get started
					</Button>
				</div>
				<div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
					<div className="relative z-1 p-0.5 rounded-2xl bg-conic from-1  to-5">
